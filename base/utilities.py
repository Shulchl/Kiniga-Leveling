...
class Database:
    ...
    async def connect(self) -> None:
        ...
        # itens
        await self.conn.fetch("CREATE TABLE IF NOT EXISTS itens (id SERIAL PRIMARY KEY, name TEXT NOT NULL UNIQUE, type TEXT NOT NULL, value INT, img TEXT NOT NULL, imgd TEXT, img_profile TEXT NOT NULL, lvmin INT DEFAULT 0, canbuy BOOLEAN DEFAULT TRUE, dest BOOLEAN DEFAULT FALSE, limitedTime TIMESTAMP, details TEXT)")
        # molds
