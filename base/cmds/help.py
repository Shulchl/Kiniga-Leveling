...
from base.classes.ansi import Foreground as fg, Format as fmt
from base.Spinovelbot import SpinovelBot
from base.classes.utilities import bot_has_permissions
from base.views.helpmenu import View as HelpView
...
class Help(commands.Cog, name="help"):
    ...
    async def help(self, interaction: discord.Interaction[SpinovelBot]):
